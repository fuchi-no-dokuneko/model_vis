...
def build(
    ...
    *,
    ...
    search = [{
        ...
        "official_parameter_estimate": (summary.get("parameter_evidence") or {}).get("parameter_count"),
        "parameter_evidence": summary.get("parameter_evidence"),
        "execution_source_version": summary.get("execution_source_version"),
        "official_config_source": summary.get("official_config_source"),
